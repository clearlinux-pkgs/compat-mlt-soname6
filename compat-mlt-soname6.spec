...
%description data
data components for the compat-mlt-soname6 package.
...
%description dev
dev components for the compat-mlt-soname6 package.


%package lib
Summary: lib components for the compat-mlt-soname6 package.
Group: Libraries
Requires: compat-mlt-soname6-data = %{version}-%{release}
Requires: compat-mlt-soname6-license = %{version}-%{release}

%description lib
lib components for the compat-mlt-soname6 package.


%package license
Summary: license components for the compat-mlt-soname6 package.
Group: Default

%description license
license components for the compat-mlt-soname6 package.


%prep
%setup -q -n mlt-6.26.1
cd %{_builddir}/mlt-6.26.1
...
/usr/share/mlt/plus/filter_strobe.yml
...
/usr/share/mlt/presets/consumer/avformat/AV1
...
/usr/share/package-licenses/compat-mlt-soname6/2627ff03833f74ed51a7f43c55d30b249b6a0707
/usr/share/package-licenses/compat-mlt-soname6/3704f4680301a60004b20f94e0b5b8c7ff1484a9
